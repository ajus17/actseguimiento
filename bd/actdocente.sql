...
create table usuarios(
    ...
    tipo int,
    CONSTRAINT fkpermiso FOREIGN KEY (tipo) REFERENCES estados(codPermiso),
    CONSTRAINT fkcargo FOREIGN KEY (cargo) REFERENCES cargos(codCargo) 
);
...
create table actividades(
    ...
    participante int,
	CONSTRAINT fkparticipante FOREIGN KEY (participante) REFERENCES usuarios(codUsuario)
);
...
create table capacitacion(
    ...
    objetivos varchar(500),
    participante int, 
    CONSTRAINT fkparticipantecp FOREIGN KEY (participante) REFERENCES usuarios(codUsuario)
    );
